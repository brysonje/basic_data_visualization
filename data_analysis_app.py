...
st.write("Please, use the left side panel to input your selections")
st.write("1. Let's start by **uploading** the file")

# sidebar
st.sidebar.header("Left side panel for user input")
...
if upload_csv_file:
    ...
    st.write("Check the **left box** when ready")
